import { Users, Clock, Bell, Loader2 } from "lucide-react";
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="text-center bg-muted rounded-lg p-4">
            ...
            <p className="text-3xl font-bold" data-testid="text-current-calling">{waiting.currentCalling}번</p>
          </div>

          <div className="flex items-center justify-center gap-2 text-foreground">
            <Users className="w-5 h-5 text-muted-foreground" />
            <p className="text-lg">
              <span className="font-semibold" data-testid="text-waiting-ahead">{waiting.waitingAhead}명</span> 앞에 대기 중
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-foreground">
            ...
            <p className="text-lg">
              약 <span className="font-semibold" data-testid="text-estimated-time">{waiting.estimatedTime}분</span> 후 입장
            </p>
          </div>
          ...
          <div className="text-center pt-2 border-t border-border">
            ...
            {waiting.menu && (
              <p className="text-sm font-medium mt-1" data-testid="text-menu">{waiting.menu}</p>
            )}
          </div>
