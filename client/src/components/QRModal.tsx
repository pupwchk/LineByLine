...
import { QrCode, MapPin, Clock, Loader2, AlertCircle, CheckCircle2 } from "lucide-react";
      ...
      <DialogContent className="max-w-sm mx-auto">
        ...
        {step === "expired" && (
          <div className="py-8 space-y-4 text-center">
            ...
            <div>
              <p className="font-medium text-lg" data-testid="qr-expired-message">QR 코드가 만료되었습니다</p>
