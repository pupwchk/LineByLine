...
import { Utensils, BookOpen, Dumbbell, Building, RefreshCw } from "lucide-react";
...
export function HomePage({ onNavigateToWaiting, onNavigateToDetail }: HomePageProps) {
  ...
  const filteredFacilities = activeTab === "all"
    ? facilities
    : facilities.filter((f) => f.type === activeTab.toUpperCase());
