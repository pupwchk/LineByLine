import { User, Moon, Sun, Bell, AlertCircle, Loader2 } from "lucide-react";
...
export function MyPage() {
  ...
  useMetaDescription("내 정보와 이용 내역을 확인하세요. 앱 설정, 다크모드, 알림 설정을 관리할 수 있습니다.");
      ...
      <div className="max-w-lg mx-auto px-4 py-4 space-y-4">
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="font-semibold text-lg" data-testid="text-username">게스트</p>
