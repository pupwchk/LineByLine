...
import { QrCode, Clock, MapPin, ChevronRight, Ticket, AlertCircle } from "lucide-react";
...
export default function OrdersPage() {
  ...
  const activeOrders = orders.filter(o => o.status === "PAID" || o.status === "QR_ACTIVE" || o.status === "QR_EXPIRED");
